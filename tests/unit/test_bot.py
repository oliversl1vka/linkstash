...
def test_count_pending_brain_changes_excludes_non_skill_md_under_skills():
    status_lines = [
        "?? Claude-Code/skills/dev/testing/browser-regression-testing/SKILL.md",
        "?? Claude-Code/skills/dev/testing/browser-regression-testing/README.md",
        "?? Claude-Code/skills/dev/testing/browser-regression-testing/notes.md",
    ]
